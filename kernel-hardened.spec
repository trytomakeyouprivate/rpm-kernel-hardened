...
Release: 1%{?dist}
Source0: https://mirror.chaoticum.net/arch/extra/os/x86_64/linux-hardened-6.0.17.hardened1-1-x86_64.pkg.tar.zst
...
%define _kerneldir 6.0.17-hardened1-1-hardened
