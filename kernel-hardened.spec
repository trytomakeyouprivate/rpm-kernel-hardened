...
Release: 1%{?dist}
Source0: https://mirror.f4st.host/archlinux/extra/os/x86_64/linux-hardened-6.1.10.hardened1-1-x86_64.pkg.tar.zst
...
%define _kerneldir 6.1.10-hardened1-1-hardened
