...
Release: 1%{?dist}
Source0: https://europe.mirror.pkgbuild.com/extra/os/x86_64/linux-hardened-6.1.6.hardened2-2-x86_64.pkg.tar.zst
...
%define _kerneldir 6.1.6-hardened2-2-hardened
